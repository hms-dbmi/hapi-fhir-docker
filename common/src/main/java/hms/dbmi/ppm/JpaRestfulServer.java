...
public class JpaRestfulServer extends RestfulServer {
    ...
    protected void initialize() throws ServletException {
        ...
        if (fhirVersion == FhirVersionEnum.DSTU2) {
            ...
            //#else
            //$JpaConformanceProviderR4 confProvider = new JpaConformanceProviderR4(this, systemDao, daoConfig);
            //#endif
        ...
        //#if hapi_fhir_version_major >=4
            ...
            //#else
            //$JpaConformanceProviderR5 confProvider = new JpaConformanceProviderR5(this, systemDao, daoConfig);
            //#endif
